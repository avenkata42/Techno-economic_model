...
% Defining the base case values for the sensitivity parameters for the 3 cases 
    %     bc =[0.9	0.75	1.5	3.5	0.95	165	7	0.75	0.65	1	1.15	0.015	0.65	0.25	0.85	6	1500	0.8	20	7	1.5	10000	60 7]; %op
    bc=[0.8	1	2	2.8	0.9	200	3	1	0.35	0.5	1	0.02	0.5	0.2	0.975	3.5	1100	1.2	25	6 1.5	10000	70	4];  %bc
